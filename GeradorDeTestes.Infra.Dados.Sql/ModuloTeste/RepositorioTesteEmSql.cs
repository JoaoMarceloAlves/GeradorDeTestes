...
namespace GeradorDeTestes.Infra.Dados.Sql.ModuloTeste
{
    public class RepositorioTesteEmSql : RepositorioEmSqlBase<Teste, MapeadorTeste>, IRepositorioTeste
    {
        ...
        private const string sqlSelecionarQuestoesSemTeste =
        @"SELECT 
                Q.[ID]            QUESTAO_ID
	           ,Q.[ENUNCIADO]     QUESTAO_ENUNCIADO
               ,Q.[RESPOSTA]      QUESTAO_RESPOSTA
            ...
            ON
              M.[DISCIPLINA_ID] = D.[ID]
            LEFT JOIN [TBTESTE_TBQUESTAO] AS TQ
            ON 
              Q.[ID] = TQ.[QUESTAO_ID]
            WHERE 
             TQ.[QUESTAO_ID] IS NULL";
        ...
        public List<Questao> SelecionarQuestoesSemTeste()
        {
            ...
            //cria um comando e relaciona com a conexão aberta
            SqlCommand comandoSelecionarTodos = conexaoComBanco.CreateCommand();
            comandoSelecionarTodos.CommandText = sqlSelecionarQuestoesSemTeste;
        ...
        public List<Questao> SelecionarQuestoesComTeste()
        {
            //obter a conexão com o banco e abrir ela
            SqlConnection conexaoComBanco = new SqlConnection(enderecoBanco);
            conexaoComBanco.Open();
